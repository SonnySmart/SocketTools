...
inline void sleep_ms(float ms)
{
    useconds_t time = (useconds_t)(ms * 1000 * 1000);
	usleep(time);
}
#endif
...
//授权信息
//#ifdef 	WIN32
//const TCHAR szCompilation[]=TEXT("11E9E77D-C628-4FD6-AC60-91A541DBD5C1");
//#else
//#define  szCompilation  "11E9E77D-C628-4FD6-AC60-91A541DBD5C1" //@compilation
//#endif
#ifdef __cplusplus
}
#endif
