#ifndef __CSocketService_H__
#define __CSocketService_H__
...
class CSocketService :public IObj,public ISocketServer
{
	...
	float m_lWaitTime;//不使用long是因为long在64位ios/linux下是64位的
private:
...
public:
	...
	virtual void SetWaitTime(float time);
