...
public:
	...
	friend std::ostream& operator<<(std::ostream& out, GameMD5 md5);
#else
	template<class charT, class traits>
	friend basic_ostream<charT, traits>& operator<<(basic_ostream<charT, traits>& out, const GameMD5* md5);
#endif
